...
admin = ["ue4ee9ad473e73c2a55641ecbc318f955","ud1e6d7cbc78dc51524f2ae48ec431024"]
...
#--------------------------------------------------------
                ...
                if wait["likeOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"もうしました")
            elif msg.text in ["いいねoff","Auto like:off"]:
